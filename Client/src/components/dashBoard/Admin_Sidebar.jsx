  ...
  return (
    <div className='bg-gray-800 text-white h-screen fixed left-0 top-0 bottom-0 space-y-2 w-64'>
       ...
       <div className='px-4'>
        ...
        <NavLink to='/admin-dashboard/employees' className={({isActive})=>`${isActive ? 'bg-teal-600' : ''} flex items-center space-x-4  py-2.5 px-4 rounded`} >
            <FaUser />
            <span>Employees</span>
        </NavLink>
        ...
        <NavLink to='/admin-dashboard/sallary/add'  className={({isActive})=>`${isActive ? 'bg-teal-600' : ''} flex items-center space-x-4  py-2.5 px-4 rounded`} >
            <FaMoneyBillWave />
            <span>Sallary</span>
        </NavLink>
