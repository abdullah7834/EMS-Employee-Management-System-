...
export const fetchDepartments = async () => {
    let departments 
    try {
      const res = await axios.get("https://ems-employee-management-system-api.vercel.app/api/department", {
        headers: {
  ...
  export const getEmployees  = async (id) => {
    let employees 
    try {
      const res = await axios.get(`https://ems-employee-management-system-api.vercel.app/api/employee/department/${id}`, {
        headers: {
          Authorization: `Bearer ${localStorage.getItem("token")}`,
        },
    });
